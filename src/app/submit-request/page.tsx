                                ...
                                {isSuccess ? (
                                    <div className="text-center py-10 space-y-6">
                                        ...
                                        <p className="text-zinc-500 leading-relaxed max-w-sm mx-auto">
                                            Your story is in our hands now. We're performing a quick vibe check to ensure everything is legit—check the board soon to see if you've hit the community board!
                                        </p>
                                        <button
